...
<img src="[[phpthumb? &cacheFolder=`assets/cache/images` &input=`[+dr.source.src+]` &options=`w=[+dr.source.width+],h=[+dr.source.height+],fltr=usm|40|1|3,zc=1,q-90`]]" width="[+dr.source.width+]" height="[+dr.source.height+]" alt="[+dr.source.alt+]" title="Click to enlarge" />
